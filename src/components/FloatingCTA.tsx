export function FloatingCTA() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a href="tel:8175550198" className="w-14 h-14 bg-brand-cta text-brand-charcoal rounded-full shadow-xl flex items-center justify-center hover:bg-[#D9B92E] transition-colors group relative border border-white/50">

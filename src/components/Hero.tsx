  ...
  return (
    <section className="relative w-full h-[600px] lg:h-[660px] bg-brand-charcoal flex items-center">
      <div className="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" alt="Aerial view of residential homes with new roofs" className="w-full h-full object-cover object-center" />

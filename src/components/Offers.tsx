        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 md:gap-8">
          <div className="bg-white text-brand-charcoal p-2 rounded-card shadow-xl w-full max-w-[500px]">
            <div className="coupon-border h-full p-8 flex flex-col items-center text-center">
              ...
              <h3 className="font-serif text-2xl font-bold mb-2 text-brand-brown">Free Premium Upgrade</h3>
              <p className="text-brand-muted mb-6">Upgrade to Class 4 Impact Resistant shingles for the price of standard architectural shingles on any full roof replacement.</p>
              ...
              <span className="text-xs text-brand-muted mt-4 block">*Restrictions apply. Mention this offer during estimate.</span>
            </div>
          </div>
          ...
          <div className="bg-white text-brand-charcoal p-2 rounded-card shadow-xl w-full max-w-[500px]">
            <div className="coupon-border h-full p-8 flex flex-col items-center text-center">
              ...
              <h3 className="font-serif text-2xl font-bold mb-2 text-brand-brown">$250 Referral Bonus</h3>
              <p className="text-brand-muted mb-6">Refer a friend or neighbor to KingdomCare! When they complete a full roof replacement, you'll receive a $250 Visa gift card.</p>
              <a href="#" className="bg-brand-cta text-brand-charcoal px-6 py-2.5 rounded-btn font-bold hover:bg-[#D9B92E] transition-colors w-full sm:w-auto mt-auto">
                Submit a Referral
              </a>
              <span className="text-xs text-brand-muted mt-4 block">*Reward issued upon job completion & final payment.</span>
            </div>
          </div>
        </div>
      </div>

        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <input
              ...
              className="w-full border border-brand-border rounded-input px-4 py-3 focus:outline-none focus:border-brand-gold transition-colors"
              value={formData.name}
            ...
            />
            <select
              className="w-full border border-brand-border rounded-input px-4 py-3 focus:outline-none focus:border-brand-gold transition-colors bg-white"
            ...
            />
            <button type="submit" className="btn-cta px-6 py-3 shadow-sm">
              Submit Request
            </button>
          </form>
        )}
